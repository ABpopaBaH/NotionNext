...
const BLOG = {
  ...
  NOTION_PAGE_ID: '218b47ec74a380f08ab2e02ec1c33bce,diary:24ab47ec74a380d793f0dab602e4ac92',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'wang1ying', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '世界上不是只有你和我吗', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://1ying.wang', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '语言学, 博客', // 网站关键词 英文逗号隔开
  BING_SITE_VERIFICATION: '3E8BFC4A364399319DC349B0E515A39A', // 必应站点验证
